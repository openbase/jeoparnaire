...
import org.openbase.jeoparnaire.tools.AppExecutorService;
 ...
 */
public class TaskPostExecutionState extends AbstractGameState {

    @Override
    public Class<? extends State> call() throws CouldNotPerformException {
        if (gameController.getActiveQuest().hasPostExecutionCommand()) {
            AppExecutorService.execute(gameController.getActiveQuest().getPostExecutionCommand(), this);
        }
        return TaskSolving2State.class;
    }
