 ...
 */
public class TaskFinalExecutionState extends AbstractGameState {

    @Override
    public Class<? extends State> call() throws CouldNotPerformException {
        AppExecutorService.execute(gameController.getActiveQuest().getFinalExecutionCommand(), this);
        Voting.getInstance().updatePoints();
        return PresentQuestPointsState.class;
    }
