 ...
 */
public class TaskPreExecutionState extends AbstractGameState {

    @Override
    public Class<? extends State> call() throws CouldNotPerformException {
        AppExecutorService.execute(gameController.getActiveQuest().getPreExecutionCommand(), this);
        return InitVoteState.class;
    }
